...
# spiffe = { version = "0.16", features = ["x509-source"] }

# OR JWT workloads (recommended)
# spiffe = { version = "0.16", features = ["jwt-source"] }

# OR Direct Workload API usage
# spiffe = { version = "0.16", features = ["workload-api"] }
```
...
```toml
[dependencies]
spiffe = { version = "0.16", features = ["jwt-verify-rust-crypto"] }
```
...
```toml
[dependencies]
spiffe = { version = "0.16", features = ["jwt-verify-aws-lc-rs"] }
```
...
```toml
[dependencies]
spiffe = { version = "0.16", features = ["logging"] }
```
...
```toml
[dependencies]
spiffe = { version = "0.16", features = ["tracing"] }
```
...
```toml
[dependencies]
spiffe = { version = "0.16", features = ["workload-api-core"] }
```
